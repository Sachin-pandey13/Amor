...
OUTPUT_PATH = (
    "data/raw/amor_100k/corpus.jsonl"
)

MANIFEST_PATH = (
    "data/raw/amor_100k/manifest.json"
)
...
def acquire_source(
    ...
    The Hugging Face dataset remains streamed and is
    never loaded completely into memory.
    """

    documents = []
    actual_tokens = 0

    # Large enough to allow us to reach the requested
    # token budget without unnecessarily scanning huge
    ...
    for record in stream_dataset(
        ...
        # Do not intentionally exceed the source budget.
        if (
